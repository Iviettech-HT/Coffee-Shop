    ...
    <body>
        ...
        <main>
            <div class="container">
                ...
                <mvc:form action="${pageContext.request.contextPath}/user/cap-nhat-thong-tin-ca-nhan" method="POST" 
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span style="color:#5bd75b;">${messageSuccess}</span>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
        ...
        <script type="text/javascript">
            ...
            btnChangePassword.onclick = function () {
                ...
                this.parentNode
                        .parentNode
                        .innerHTML = '<td rowspan="4" style="vertical-align:top; padding-top:10px;" class="title">Thay đổi mật khẩu</td>'
            }
        </script>
